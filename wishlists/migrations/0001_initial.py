# Generated by Django 5.2.4 on 2025-12-25 10:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'db_table': 'wishlist',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'product'], name='wishlist_user_id_82130e_idx'), models.Index(fields=['user', 'created_at'], name='wishlist_user_id_a6b108_idx')],
